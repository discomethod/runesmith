...
DICT_COLUMNS_DATA = dict(
    TYPE_GLOBAL=dict(TYPE_CHAMPION=COLUMNS_C_DATA, TYPE_SPELL=COLUMNS_S_DATA, TYPE_RELIC=COLUMNS_S_DATA,
                     TYPE_EQUIPMENT=COLUMNS_S_DATA),
    TYPE_PERSONAL=dict(TYPE_CHAMPION=COLUMNS_P_C_DATA, TYPE_SPELL=COLUMNS_P_S_DATA, TYPE_RELIC=COLUMNS_P_S_DATA,
